                ...
                <InputField label="Area (hectares)">
                    <>
                        <input 
                           ...
                           value={formData.area} 
                           readOnly 
                           className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-gray-100 cursor-not-allowed"
                        />
                         <p className="mt-1 text-xs text-gray-500">Calculated from map drawing.</p>
                    </>
                </InputField>
            </div>
