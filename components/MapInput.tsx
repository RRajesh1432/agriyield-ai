...
const MapInput: React.FC<MapInputProps> = ({ onShapeChange }) => {
    ...
    useEffect(() => {
        if (mapContainerRef.current && !mapRef.current && typeof L !== 'undefined') {
            ...
            // ENHANCEMENT: Use a satellite tile layer more appropriate for agriculture
            L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
                attribution: 'Tiles &copy; Esri &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community'
            }).addTo(map);

            // ENHANCEMENT: Attempt to geolocate the user for a better initial view
            ...
            map.on(L.Draw.Event.CREATED, (event: any) => {
                ...
                // ENHANCEMENT: Zoom to the drawn shape for better context
